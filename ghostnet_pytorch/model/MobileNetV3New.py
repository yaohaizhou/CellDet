...
class MobileNetV3(nn.Module):
    def __init__(self, n_class=2, input_size=224, dropout=0.8, mode='small', width_mult=1.0):
...
def mobilenet(mymode='small', **kwargs):
    model = MobileNetV3(mode=mymode,**kwargs)
...
if __name__ == '__main__':
    ...
    # input_size=torch.rand(1, 1, 500, 500)
